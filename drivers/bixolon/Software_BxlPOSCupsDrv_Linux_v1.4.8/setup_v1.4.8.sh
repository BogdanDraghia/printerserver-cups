...
then
	FILTER=rastertoBixolon_v1.4.8_x64
elif [ ${LINUX_CHECK_ARCH_x86} -eq 1 ]
then
	FILTER=rastertoBixolon_v1.4.8_x86
elif [ ${LINUX_CHECK_ARCH_AARCH64} -eq 1 ]
then
	FILTER=rastertoBixolon_v1.4.8_RaspberryPi_x64
elif [ ${LINUX_CHECK_ARCH_ARMV7L} -eq 1 ]
then
	FILTER=rastertoBixolon_v1.4.8_RaspberryPi_x86
else
